...
all_model_metrics <- tibble(Model = c("Linear Reg", "Neural Net (MLP)", "kNN", "Random Forest"), RMSE = c(res_lin$mean[1], res_NN$.estimate[1], res_kNN$.estimate[1], res_rf$.estimate[1]))
...
*To answer Question 3, we conducted a random forest model with the removal of the CMAQ and AOD variables. After the analysis, we found that the model works best when the variables are included (RMSE = 1.7305504) rather than when not included (RMSE = 1.7305504).*
